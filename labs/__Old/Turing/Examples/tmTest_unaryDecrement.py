...
tm_code = "tm-code-unaryDec.txt"

# Define the test input tapes with proper output.
test_1 = ["@,b;","@,;"]
test_2 = ["@,1,b;","@,;"]
test_3 = ["@,1,1,1,1;","@,1,1,1;"]
tests = [test_1,test_2,test_3]


# Incrementer used for naming files.
i = 1
for test in tests: 

    # Prepare the input tape. 
    test_file_name = "tm-tape-unaryDec-test-" + str(i) + ".txt"
    ...
    # Reformat to remove all blank cells. This assumes blank cells at the end only! 
    ...
    # Increment for the file name of the next test case. 
    i += 1
