...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item $A \ \vdash \ ((A \to B) \to B$
		\item $((A \to B) \to B) \to B \ \vdash \ A \to B$
		\item $A \to B \ \vdash ((A \to B) \to B) \to B$
	\end{enumerate}	

	\item \textbf{Distributivity of Disjunction and Conjunction.} Each of these sequents can be proved with positive minimal logic alone. These proofs are longer than those written above and some planning will help keep these proofs neat and manageable. 
