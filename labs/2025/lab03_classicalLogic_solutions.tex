...
\noindent\fbox{
	\parbox{\textwidth}{
		...
		Relevant reading: \href{https://leanprover-community.github.io/logic_and_proof/index.html}{L$\exists\forall$N Chapter 5}
					...
					\infer[\RAA,2]{A \lor \lnot A}
						{\infer[\MP]{\bot}
							{\infer[\lor I_{R}]{A \lor \lnot A}
								{\infer[\to I,1]{\lnot A}
									{\infer[\MP]{\bot}
										{\infer[\lor I_{R}]{A \lor \lnot A}{\infer[1]{\cancel{A}}{}}
										&
		...
		\begin{center}
				$\begin{array}{c}
					\infer[\RAA,3]{\lnot A \lor \lnot B}
						{\infer[]{\bot}
							{\infer[\lor I{L}]{\lnot A \lor \lnot B}
								{\infer[\to I,1]{\lnot A}
									{\infer[\MP]{\bot}
			...
			\begin{center}
				$\begin{array}{c}
					\infer[\RAA,2]{(A \to B) \lor (B \to C)}
						{\infer[]{\bot}
							{\infer[\lor I_{R}]{(A \to B) \lor (B \to C)}
								{\infer[\to I,1]{B \to C}
									{\infer[\XF]{C}
										{\infer[\MP]{\bot}
											{\infer[2]{\cancel{\lnot[(A \to B) \lor (B \to C)]}}{}
											&
											\infer[\lor I_{L}]{(A \to B) \lor (B \to C)}
												{\infer[\to I]{A \to B}
													{\infer[1]{\cancel{B}}{}}}}}}}
							&
							\infer[2]{\cancel{\lnot[(A \to B) \lor (B \to C)]}}{}}}				
			...
			$\begin{array}{c}
				\infer[\to I, A]{A \to B \lor \lnot B}
					{\infer[\RAA,2]{B \lor \lnot B}
						{\infer[\MP]{\bot}
							{\infer[\lor I_{R}]{B \lor \lnot B}
								{\infer[\to I,1]{\lnot B}
									{\infer[\MP]{\bot}
										{\infer[\lor I_{L}]{B \lor \lnot B}{\infer[1]{\cancel{B}}{}}
										&
